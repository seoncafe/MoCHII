! MoCHII: copied from MoCafe_v2.00/src/utility.f90 (2026-07-11)
module utility
...
contains
   ...
   if (ext /= 'fits' .and. ext /= 'txt' .and. ext /= 'dat') then
      jj = ii-2
   ...
   remainder = mod(nloop, int(nnodes, int64))
   ...
   remainder = mod(nloop, int(nthreads, int64))
...
100 continue
   ...
   write(date_time,'(i4,a,i2.2,a,i2.2,1x,i2.2,a,i2.2,a,i2.2)') &
