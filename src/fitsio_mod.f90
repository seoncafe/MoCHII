! MoCHII: copied from MoCafe_v2.00/src/fitsio_mod.f90 (2026-07-11)
module fitsio_mod
!
...
!--------------------
  ...
  ! nonzero, so a plain read (get_dimension/read_3D) would wrongly report a
  ! failure; ftflmd guards against that.
  tmp_status = 0
