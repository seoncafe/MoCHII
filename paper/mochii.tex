...
pair over $5000$--$20000$~K is now a standing gate.
...
\emph{Temperature.}  The weighted temperature is 8170~K at HII40 and
6926~K at HII20.  Both match the \textsc{Cloudy} c25.00 solution of the
...
$\nelec$, Section~\ref{sec:cooldata} --- gives the 8170 and 6926~K that
...
% specification, 2^25 packets, conv_crit='vol', two-way charge exchange as the
% default and the corrected oxygen charge-exchange data); line entries are the
% L/L(Hbeta) column of
% results/continuous_energy/m1_oxfix/hii{40,20}_oxfix_lines.txt
...
default reaches 8170~K, matching \textsc{Cloudy} to $0.5\%$
...
with the published set ([Ne\,\textsc{iii}] 15.5\,$\mu$m 0.286 in a
published 0.263--0.429; [Ne\,\textsc{ii}] 12.8\,$\mu$m 0.205 in
...
[O\,\textsc{iii}] 5007+4959 is 2.35 against a published 1.64--3.27, and the
...
6300+6363 is 0.0241 at HII40, above the published 0.0059--0.012 range; it is
...
against $+0.03\%$ in the weighted temperature).  The complete
...
[O\,\textsc{i}] 6300+6363 ($2.15\times$, on a line the thin neutral edge and
...
published range for both (0.781 and 0.744).  Both C25 and \MoCHII{} have the
...
density, the
$n_{\mathrm{p}}n_{\mathrm{e}}$-weighted temperature is 8170~K at HII40 and
6926~K at HII20, matching the \textsc{Cloudy} c25.00 solution of the same
