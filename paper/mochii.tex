...
\emph{Temperature.}  The weighted temperature is 8211~K at HII40 and
7025~K at HII20.  Both match a current \textsc{Cloudy} c25.00 run of the
same two models --- 8210~K and 6910~K --- to $0.7$~K and $1.7\%$, and both
...
published spread at both, 7569~K at HII40 against a published 7370--8318~K
and 7045~K at HII20 against a published 6562--7224~K.  The converged
...
$\nelec$, Section~\ref{sec:cooldata} --- gives the 8211 and 7025~K that
...
default reaches 8211~K, matching \textsc{Cloudy} to $0.7$~K
...
published 0.263--0.429; [Ne\,\textsc{ii}] 12.8\,$\mu$m 0.207 in
...
[O\,\textsc{iii}] 5007+4959 is 2.40 against a published 1.64--3.27, and the
auroral [O\,\textsc{iii}] 4363, the most temperature-sensitive entry in the
tables, is 0.0045 against a published 0.0022--0.0070.  The lines that fall
...
6300+6363 at HII40 (0.0170 against 0.0059--0.012), which is fed by the thin
...
[O\,\textsc{i}] 6300+6363 ($1.52\times$, on a line the thin neutral edge and
...
\MoCHII{} 0.329, so what would be a $2.4\times$ excess against the 1990s
...
(0.322 against 0.465--0.604) fall \emph{below} every published code, and so
does C25 (0.209 and 0.293), while [S\,\textsc{ii}] 6716+6731 sits inside the
published range for both (0.809 and 0.744).  Both modern calculations
...
($+0.34\%$), reproducing the classic dusty reduction $R/R_0 = 0.722$
...
2.197~pc, is within $0.4\%$ of the absorption-only 2.206~pc: the in-band
...
$n_{\mathrm{p}}n_{\mathrm{e}}$-weighted temperature is 8211~K at HII40 and
7025~K at HII20, matching a current \textsc{Cloudy} c25.00 run of the same
two models (8210 and 6910~K) to $0.7$~K and $1.7\%$; both models are
