...
the diffuse field emits.  The axes left are the transport of those photons,
which none of the four touched, and the \HeI{} ground-continuum atomic data,
where $\alpha_1$ from the Milne integral and the fitted
$\alpha_A - \alpha_B$ disagree by 2--$3.4\%$ --- in exactly the continuum
whose front is discrepant.  At HII40 the diffuse band luminosity converges
to $\sim$$0.5\,L_\star$.
