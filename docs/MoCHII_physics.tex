...
from the normalized Planck or tabulated source-energy CDF and its cross
sections are evaluated at that energy.  Every packet carries
$L_{\rm pkt} = L_{\rm band}/N$.  The $n_\nu$ bins
(\code{par\%nnu\_ion}; gates use 32) are then diagnostic $J_E$ tally bins;
their count cannot alter the physical solution.
