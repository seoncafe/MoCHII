...
He\,\textsc{i} recombination lines use the same interpolator (a third
...
\code{data/atomic}) onto a $21 \times 14$ $(T, n_e)$ grid.  Eight
H\,\textsc{ii}-region diagnostics are exported
