...
than inverting two neighbouring temperature rows and interpolating the
resulting energies.
...
fix, not the explanation of the Cloudy front residual.
...
the excited-He branch); and one for the flat two-photon energy when that
branch is selected.  Coordinates that are irrelevant to a selected channel
...
He\,\textsc{i}  & $n_e n_{\rm HeII}$  & 1.514  &
  $6.23{\times}10^{-14}(T_4)^{-0.827}$ (BSS99) \\
...
He\,\textsc{i}.  Only H\,\textsc{i} carries the collisional suppression
\begin{equation}
...
H-ionizing fraction 0.56.  The He\,\textsc{ii} continuum, which extends to
