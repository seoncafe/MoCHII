...
\label{sec:heimeta}
The Porter case-B 10830~\AA\ table above is a collisional-radiative
...
the 10830~\AA\ \emph{absorption} opacity --- the observables of exoplanet
transit, chromospheric, and PDR 10830 work, where the line is seen against
...
row, and in particular \emph{nothing is summed onto} the Porter 10830 line
(which already carries the metastable-collisional term --- summing an
explicit collisional 10830 would double-count).
...
\paragraph{10830~\AA\ absorption (Stage 2).}  From $n_3$ the line-center
...
time (dense H\,\textsc{ii}), not a faithful outflow benchmark; (ii)~10830 can
...
\subsection{He\,\textsc{i} 2$^3$S metastable and 10830~\AA\ absorption}
...
diffuse \code{HEI\_F3S} consistency.  \textbf{Stage 2 (10830 absorption)}:
the LINE10830 constants carry the $f$ ratio 1:3:5 and $A =
