...
emission process all six compute, the hydrogen recombination lines, and finds
three distinct method classes and no two codes agreeing on how the case A/B
...
also has the most physical hydrogen-line treatment of the six, a case
...
emission process all six codes compute, which makes them the cleanest
available cross-section through the design choices of the family.  The six
implementations fall into three method classes.
...
The three families can be compared against one common standard, because
\MoCHII{}'s parse of \code{e1bx.d} is the same Storey--Hummer case-B table
that four of the six codes ultimately cite.  Table~\ref{tab:hbetafits}
...
\paragraph{Density dependence.}  \MoCHII{}, \Mappings{}, \Mthree{} and
\Mocassin{}'s output ratios carry it; \Wood{}, \CMI{}, \Torus{} and
\Mocassin{}'s iteration path do not.  The cost is small in an \HII{} region
...
recombination row stays a pure recombination quantity).  \Wood{}, \CMI{},
