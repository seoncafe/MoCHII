...
\textbf{8162~K} at HII40 --- inside the published $7720$--$8199$~K range and
$0.58\%$ below \Cloudy{}'s 8210~K --- and \textbf{6917~K} at HII20, which sits
...
\emph{current} figures, in the last column of the table, are $8162$~K at HII40
and $6917$~K at HII20, and they change the HII20 verdict:
...
\midrule
HII40 & 7720--8199 & 8210 & \textbf{8162} & inside published; $0.58\%$ below \Cloudy{} \\
HII20 & 6402--6749 & 6910 & \textbf{6917} & above published; $0.10\%$ above \Cloudy{} \\
\bottomrule
\end{tabular}
\end{center}
...
first raised $\langle T\rangle$ to 8211 and 7025~K and then settled at 8162 and
6917~K; Section~\ref{sec:limit} lists the intermediate steps.  The
...
$\langle T[N_{\rm p}N_{\rm e}]\rangle$ / K & 9159 & 7894 & \textbf{8162} & 8210 & 7720--8199 \\
...
$\langle T[N_{\rm p}N_{\rm e}]\rangle$ / K & 7370 & 6376 & \textbf{6917} & 6910 & 6402--6749 \\
...
\paragraph{From 8211/7025 to the current 8162/6917~K.}  The two temperatures
...
resolved \HeI{} diffuse cascade           & \code{HEI\_CASCADE\_DIFFUSE\_PLAN.md}, & \textbf{8162} & \textbf{6917} \\
...
Table~\ref{tab:bench}, $0.4\%$ above \MoCHII{}'s current $8162$~K and $0.2\%$
...
their current values: $8162$~K at HII40, inside the published
$7720$--$8199$~K range and $0.58\%$ below \Cloudy{}; and $6917$~K at HII20,
above the published $6402$--$6749$~K range but within $0.10\%$ of \Cloudy{}
